...
* Enhancements
  ...
  * Latvian translation for default text added (Arturs Meisters)
	* TinyMCE initialization/configuration script moved to separate file in 'public/javascripts' directory (Rolands Bondars)
