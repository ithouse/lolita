...
module UploadColumn
  ...
  module ActiveRecordExtension
    ...
    module ClassMethods
      ...
      def audio_column(name, options={})
        upload_column(name, options.reverse_merge(UploadColumn.audio_column_configuration))
      end
      def video_column(name, options={})
        upload_column(name, options.reverse_merge(UploadColumn.video_column_configuration))
      end
      #-----------------------
