...
class DateHelperTest < Test::Unit::TestCase
  ...
  def test_distance_in_words
    ...
    assert_equal "about 3 days", distance_of_time_in_words(from, Time.mktime(2004, 3, 9, 15, 40))
    ...
    assert_equal "less than 20 seconds", distance_of_time_in_words(from, Time.mktime(2004, 3, 6, 21, 41, 28), true)
    assert_equal "half a minute", distance_of_time_in_words(from, Time.mktime(2004, 3, 6, 21, 41, 38), true)
    ...
    assert_equal "half a minute", distance_of_time_in_words(Time.mktime(2004, 3, 6, 21, 41, 38), from, true)
  ...
  def test_distance_in_words_he
    ...
    #Commented test out because result is 'about %d days' hasn' been translated and my hebrew is a bit lacking.
    #Latest version of distance_of_time_in_words also adds:
    #'about %d months'
    #'about %d months'
    #'about %d years'
    #'over %d years'
    ...
    assert_equal "פחות מ-‏20 שניות", distance_of_time_in_words(from, Time.mktime(2004, 3, 6, 21, 41, 28), true)
    assert_equal "חצי דקה", distance_of_time_in_words(from, Time.mktime(2004, 3, 6, 21, 41, 38), true)
    ...
    assert_equal "חצי דקה", distance_of_time_in_words(Time.mktime(2004, 3, 6, 21, 41, 38), from, true)
